...
public class Constants {
    ...
    public static final String INTENT_ACTION_USER_CHANGE = "sinaweibo.action.USER_CHANGE";

    public static final String INTENT_ACTION_COMMENT_CHANGED = "sinaweibo.action.COMMENT_CHANGED";

    public static final String INTENT_ACTION_NOTICE = "sinaweibo.action.APPWIDGET_UPDATE";

    public static final String INTENT_ACTION_LOGOUT = "sinaweibo.action.LOGOUT";

    public static final String APP_KEY = "2320117119";

    /**
     * 当前 DEMO 应用的回调页，第三方应用可以使用自己的回调页。
     * 建议使用默认回调页：https://api.weibo.com/oauth2/default.html
     */
    public static final String REDIRECT_URL = "http://jyh.com";
