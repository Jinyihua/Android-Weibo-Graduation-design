...
import com.jyh.sinaweibo.widget.WeiboPicturesPreviewerItemTouchCallback;

import java.util.ArrayList;
import java.util.List;


public class WeiboSelectImageAdapter extends RecyclerView.Adapter<WeiboSelectImageAdapter.WeiboSelectImageHolder>
        implements
        WeiboPicturesPreviewerItemTouchCallback.ItemTouchHelperAdapter {
    ...
    public WeiboSelectImageAdapter(Callback callback) {
        mCallback = callback;
    }
    ...
    @Override
    public WeiboSelectImageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_weibo_publish_selecter, parent, false);
        if (viewType == TYPE_NONE) {
            return new WeiboSelectImageHolder(view, new WeiboSelectImageHolder.HolderListener() {
                @Override
                ...
                @Override
                public void onDrag(WeiboSelectImageHolder holder) {
                    Callback callback = mCallback;
                    if (callback != null) {
            ...
            return new WeiboSelectImageHolder(view, new View.OnClickListener() {
                @Override
    ...
    @Override
    public void onBindViewHolder(final WeiboSelectImageHolder holder, int position) {
        int size = mModels.size();
     ...
     */
    static class WeiboSelectImageHolder extends RecyclerView.ViewHolder implements WeiboPicturesPreviewerItemTouchCallback.ItemTouchHelperViewHolder {
        private ImageView mImage;
        private ImageView mDelete;
        private HolderListener mListener;

        private WeiboSelectImageHolder(View itemView, HolderListener listener) {
            super(itemView);
            mListener = listener;
            ...
            mImage.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if (holderListener != null) {
                        holderListener.onDrag(WeiboSelectImageHolder.this);
                    }
                    return true;
                }
            });
        ...
        private WeiboSelectImageHolder(View itemView, View.OnClickListener clickListener) {
            super(itemView);
        ...
        interface HolderListener {
            ...
            void onDrag(WeiboSelectImageHolder holder);
        }
    }
